...
import common_func.word_bullets_operations as word_bullet_ops
...
#Do not alter - the following functions are main processing methods for generic_instructions.py
def format_document(doc_path,region_code = None):
    ...
    for paragraph in doc.paragraphs:
        ...
        word_bullet_ops.apply_bullet_formatting(paragraph)
    ...
    word_bullet_ops.process_bullets_in_document(doc_path)   
    word_bullet_ops.set_bullet_follow_char_to_space(doc_path) 
    word_bullet_ops.set_bullet_font(doc_path)    
