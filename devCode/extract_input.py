...
from converter_modules.html2docx_integration import html2docx,HTMLtoDocx

logger = get_logger(__name__)

#Do not alter - the following functions are main processing methods for extract_input.py
...
def process_file(file_path, jurisdiction, output_path, error_path, temp_path, process_path):
    ...
    if file_path.lower().endswith('.pdf'):
        ...
        html2docx.HTMLtoWord(file_path,process_docx_path)
        logger.info(f'Converted HTML to DOCX: {process_docx_path}')
